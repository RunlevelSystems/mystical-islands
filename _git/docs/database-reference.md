...
This reference targets **Atavism 10.9** and is derived from the live `world_content` database schema in `Assets/_git/sql/world_content.sql`. It covers the Damage Plugin and all tables that participate in the combat damage pipeline.
