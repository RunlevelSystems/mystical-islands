...
--
-- Host: localhost:3306
-- Czas generowania: 02 Kwi 2026, 17:51
...
CREATE TABLE IF NOT EXISTS `island_portals` (
  ...
  `gameObject` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 AVG_ROW_LENGTH=2340 DEFAULT CHARSET=utf8mb3;
...
(1, 29, 0, 0, '-170.00', '74.00', '154.00', 0, 0, 0, 1, 0, 'spawn', '');
