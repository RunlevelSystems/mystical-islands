...
INSERT INTO `account` (`id`, `username`, `status`, `created`, `last_login`, `character_slots`, `coin_current`, `coin_total`, `coin_used`, `islands_available`, `last_logout`) VALUES
(1, 'admin', 5, '2000-01-01 00:00:00', '2026-02-28 01:27:49', 10, 0, 0, 0, 1, '2014-01-01 00:00:00');
...
) ENGINE=InnoDB AUTO_INCREMENT=47 AVG_ROW_LENGTH=2340 DEFAULT CHARSET=utf8mb3;
...
(46, 'MainWorldPvP', '', 0, 1, 'Active', NULL, 1, '', 0, 0, 51, 1, '', 0, '', -1, -1, '2026-03-02 20:36:09', '2026-03-02 20:36:09');
...
CREATE TABLE IF NOT EXISTS `island_portals` (
  ...
  `gameObject` varchar(256) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 AVG_ROW_LENGTH=2340 DEFAULT CHARSET=utf8mb3;
...
(28, 46, 0, 0, '-170.00', '74.00', '154.00', 0, 0, 0, 0, 0, 'spawn', NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=2 AVG_ROW_LENGTH=16384 DEFAULT CHARSET=utf8mb3;

--
-- Zrzut danych tabeli `world_time`
--

INSERT INTO `world_time` (`id`, `world_name`, `year`, `month`, `day`, `hour`, `minute`, `second`) VALUES
(1, 'UnityTest', 1, 1, 1, 1, 1, 1);
COMMIT;
